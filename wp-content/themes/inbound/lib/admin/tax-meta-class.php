...
if ( ! class_exists( 'SR_Tax_Meta' ) ) :
     ...
     */
        ...
        <img src="';
					...
					echo '" alt="' . esc_html__( 'Remove', 'inbound' ) . '" title="' . esc_html__( 'Remove', 'inbound' ) . '" id="remove-' . $field['id'] . '"></div>';
					$c = $c + 1;
			...
			echo '" alt="' . esc_html__( 'Add', 'inbound' ) . '" title="' . esc_html__( 'Add', 'inbound' ) . '" id="add-' . $field['id'] . '"><br/></div>';
